...
public class Demo {
    ...
    public List<Person> getall() 
    {
    	...
    	List<Person> p=((Object) obj).query(sql,(rs,rownum)->new Person(
    				rs.getInt(1),
    				rs.getString(2)
    				));
    	return p;
    ...
    public  String addPerson(@RequestBody Person p)
    {
    	...
    	int i=((Object) obj).update(s,new Object[] {p.getId(),p.getName()});
    	if(i>0)
    	{
    ...
    public String updatPerson(@RequestBody Person p)
    {
    	...
    	int i=((Object) obj).update(s,new Object[] {p.getName(),p.getId()});
    	if(i>0)
    	{
    ...
    public String deleteById(@RequestBody Person p)
    {
    	...
    	int i=((Object) obj).update(s,new Object[] {p.getId()});
    	if(i>0)
    	{
